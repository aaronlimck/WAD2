        ...
        <div   id="sample">
          ...
          <form action=""  style=" width:2700px; margin: auto;">
            ...
            <div class="w-full md:w-1/2 px-3">
              ...
              <input id="eventDescription" v-model="items[fromTheDashboard].eventDescription" class="h-60 appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" >
          ...
          <base-button  style="margin: 20px;" v-on="updateEvent()">Update</base-button>
