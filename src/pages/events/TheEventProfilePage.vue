<template>
  <base-dialog v-if="registerPopup">
    <template #default>
      <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="p-6 text-center">
          <svg
            v-if="!failed && !alreadyRegistered"
            id="icon"
          ...
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="mx-auto mb-4 w-14 h-14 text-black"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
          ...
          <div style="display: flex; justify-content: flex-end">
            <div class="bg-white rounded-lg p-5 w-80">
              ...
              <div class="flex items-center">
                ...
                <p class="my-3 text-base">Add to Calender</p>
              </div>
              <base-button
                mode="flat"
  ...
  <div class="content container mx-auto py-10 px-4">
    <div class="grid gap-4 grid-cols-3">
      ...
      <div class="col-span-3 sm:col-span-1">
        ...
        <p class="mt-3 text-zinc-600">
          SMU School of Computing and Information Systems 1<br />80 Stamford Rd,
          #B1-62, Singapore 178902
        </p>
        <!-- <div
          class="detail-tab border-solid border-2 border-gray-500 p-9 rounded-lg mb-10 mx-auto"
        >
          <div class="mb-3">
            <div class="flex pb-2">
              <svg
              ...
              <h3 class="text-1x font-semibold">Date and Time</h3>
            </div>
        ...
        <!-- <div class="button mb-10">
          <button class="rounded py-3" id="button" @click="showAndClosePopUp()">
            Jio Me For this
          </button>
        </div>
        ...
        <div class="link mb-10">
          ...
          <div
            class="border-solid border-2 border-gray-500 p-2 rounded-lg text-gray-500 flex items-center"
          >
            <input
              type="text"
              class="w-full bg-white items-center"
              :value="text"
              disabled
            />
...
export default {
  components: { CopiedAlert, BaseButton },
  data() {
    return {
      ...
      if (localStorage.getItem("userId")) {
        ...
        if (eventAttendees.includes(userId)) {
          this.notificationMessage =
            "Oops! It looks like you have already registered for the event!";
